...
import numpy as np
from envs.mpe_from_openai.multiagent.multi_discrete import MultiDiscrete
...
class MultiAgentEnv(gym.Env):
    ...
    - 在pettingzoo中用spaces表示总体(dif)
    - 按照agents的顺序传入进行spaces的初始化，pettingzoo中则是用dict表示spaces(dif)
    - 如果action_space均为离散，则用MultiDiscrete进行总体表示
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 ...
                 done_callback=None, shared_viewer=True, discrete=True):
        ...
        self.discrete_action_space = discrete  # 为True，则为离散动作空间
    ...
    def step(self, action_n):
        ...
        note:
        1. done从scenario中来，但在make_env时发现没有done_callback输入
    ...
    def render(self, mode='human'):
        ...
        for i in range(len(self.viewers)):
            ...
            if self.viewers[i] is None:
                ...
                from envs.mpe_from_openai.multiagent import rendering
